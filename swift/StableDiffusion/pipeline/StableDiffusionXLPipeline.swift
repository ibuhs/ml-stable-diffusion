...
public struct StableDiffusionXLPipeline: StableDiffusionPipelineProtocol {
    ...
    public func generateImages(
        ...
        let scheduler: [Scheduler] = (0..<config.imageCount).map { _ in
            ...
            case .dpmSolverMultistepScheduler: return DPMSolverMultistepScheduler(stepCount: config.stepCount, timeStepSpacing: config.schedulerTimestepSpacing, predictionType: config.schedulerPredictionType)
